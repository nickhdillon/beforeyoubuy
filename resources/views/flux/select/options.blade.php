...
$classes = Flux::classes()
    ...
    ->add('hard-shadow rounded-none shadow-none')
    ->add('border-2 border-zinc-950 dark:border-zinc-300')
...
<?php else: ?>
    <div popover="manual" class="hard-shadow [:where(&)]:min-w-48 [&:popover-open]:flex [&:popover-open]:flex-col rounded-none border-2 border-zinc-950 bg-white p-[.3125rem] shadow-none dark:border-zinc-300 dark:bg-zinc-800" data-flux-options>
