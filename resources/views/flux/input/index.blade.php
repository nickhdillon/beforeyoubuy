...
$classes = Flux::classes()
    ->add('block w-full rounded-none border-2 shadow-none disabled:shadow-none dark:shadow-none focus:border-emerald-600 focus:ring-0')
    ...
    ->add(match ($variant) { // Border...
        'outline' => 'border-zinc-950 disabled:border-zinc-950/50 dark:border-zinc-300 dark:disabled:border-zinc-300/50',
        'filled'  => 'border-0',
    })
