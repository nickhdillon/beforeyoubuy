<flux:modal name="collection-item-form" class="max-w-2xl" wire:close="resetForm">
    <form wire:submit="save" class="grid gap-6">
        ...
        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            <flux:button variant="primary" type="submit" class="w-full sm:w-auto" wire:target="save" wire:loading.attr="disabled">
                <span wire:loading.remove wire:target="save">{{ $item ? 'Save changes' : 'Add item' }}</span>
